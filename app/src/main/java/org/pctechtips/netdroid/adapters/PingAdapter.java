...
public class PingAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        * 3 element*/
        ...
        packetNum = output[1].substring(output[1].indexOf("=")+1, output[1].length());
        packetTtl = output[2].substring(output[2].indexOf("=")+1, output[2].length());
        packetTime = output[3].substring(output[3].indexOf("=")+1, output[3].length());
        packetTime += output[4];
        ...
        TextView pNumTxtView = (TextView) convertView.findViewById(R.id.ping_packet_num);
        TextView pAddrTxtView = (TextView) convertView.findViewById(R.id.ping_address);
        TextView pTtlTxtView = (TextView) convertView.findViewById(R.id.ping_packet_ttl);
        TextView pTimeTxtView = (TextView) convertView.findViewById(R.id.ping_packet_time);
