...
public class NetstatAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView protocolTxtView = (TextView) convertView.findViewById(R.id.protocol);
        TextView addressTxtView = (TextView) convertView.findViewById(R.id.address);
        TextView stateTxtView = (TextView) convertView.findViewById(R.id.state);
