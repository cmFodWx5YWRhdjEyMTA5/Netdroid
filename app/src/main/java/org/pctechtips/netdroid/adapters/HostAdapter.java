...
public class HostAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView hostLblTextView = (TextView) convertView.findViewById(R.id.host_label);
        TextView hostDataTextView = (TextView) convertView.findViewById(org.pctechtips.netdroid.R.id.host_data);
