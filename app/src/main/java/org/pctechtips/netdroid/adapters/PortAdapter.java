...
public class PortAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView portNumTxtView = (TextView) convertView.findViewById(R.id.port_number);
        TextView portStateTxtView = (TextView) convertView.findViewById(R.id.open_state);
        TextView serviceTxtView = (TextView) convertView.findViewById(R.id.service_name);
